const asideCards = (MatchedCards)=>{
    ...
    if (MatchedCards.find((findedCard)=>findedCard.name === MatchedCards.name)) return;
    else MatchedCards.forEach((element)=>{
        singlesCard.push(element);
    });
    console.log(singlesCard);
    if (singlesCard) setTimeout(()=>{
...
//# sourceMappingURL=index.32670df6.js.map
